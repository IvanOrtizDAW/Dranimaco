...
<head>
  ...
  <title>Pagina 2 de la galeria de imagenes de animacion y modelado 3D</title>
</head>
...
<body>
  ...
  <header>
    <nav class="menu-navegacion">
      <ul>
        ...
        <li class="menu">
          <a href="../../Ingles/DENTRO/Galeria2.php"><img class="imagen-idioma" src="../../Imagenes/Ingles.png" alt=""/></a>
        </li>
        <li class="hamburgesa">
  ...
  <section>
    <div class="galeria">
      ...
      <img src="../../Imagenes/Galeria/d.jpg" alt="" />
      <img src="../../Imagenes/Galeria/torre.jpg" alt="" />
      <img src="../../Imagenes/Galeria/dado.png" alt="" />
      <img src="../../Imagenes/Galeria/cascos.jpg" alt="" />
      <img src="../../Imagenes/Galeria/tele.jpg" alt="" />
      <img src="../../Imagenes/Galeria/castillo.jpg" alt="" />
      <img src="../../Imagenes/Galeria/naranjas.gif" alt="" />
      <img src="../../Imagenes/Galeria/personaje2.jpg" alt="" />
      <img src="../../Imagenes/Galeria/personaje3.jpg" alt="" />
      <img src="../../Imagenes/Galeria/personaje4.jpg" alt="" />
  ...
  <ul class="pagination">
    <li class="page-item">
      <a class="page-link" href="Galeria.php">Anterior</a>
    </li>
    ...
    <li class="page-item">
      <a class="page-link" href="Galeria3.php">Siguiente</a>
    </li>
  </ul>

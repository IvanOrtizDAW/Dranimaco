...
<head>
  ...
  <title>Pagina de tutoriales basicos de Dranimaco</title>
</head>
...
<body>
    ...
    <nav class="menu-navegacion">
      <ul>
        ...
        <li class="menu">
          ...
          <ul>
            <li class="menu2">
              <a href="#"><i class="fas fa-play-circle"></i> Basico</a>
            </li>
            <li class="menu2">
        ...
        <li class="menu"><a href="../../Ingles/DENTRO/basico.php"><img class="imagen-idioma"
  ...
  <section>
    ...
    <h5>Tutorial basico de balon de futbol en Blender [2.67]</h5>
    <div class="tutoriales-basicos">
      <iframe class="video" src="https://www.youtube.com/embed/vH4inB-4qFg" 
        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <h5>Tutorial Principiantes blender 2.8 Modelado taza</h5>
    <div class="tutoriales-basicos">
      <iframe  class="video" src="https://www.youtube.com/embed/2m_vNs67Bb4" 
        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <h5>Videotutorial rápido para hacer una silla básica en Blender 2.7, 2.6 o 2.5. En Español</h5>
    <div class="tutoriales-basicos">
      <iframe  class="video" src="https://www.youtube.com/embed/8dlJ85qP0Zc" 
        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>

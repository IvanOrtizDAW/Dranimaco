...
<nav class="menu-navegacion">
    ...
    <li class="menu">
          ...
          <li class="menu"><a href="../../Ingles/DENTRO/historia.php"><img class="imagen-idioma" src="../../Imagenes/Ingles.png" alt="" width="5px" height="10px"></a></li>
          <li class="hamburgesa">
  ...
  <p>Si alguien dice “modelado 3D”, todos pensamos rápidamente en Pixar o en Toy Story, así como en el resto de películas del estilo que han redefinido el concepto de cine de animación de las últimas décadas.</p>

<p>Sin embargo, el concepto de modelado 3D o computación gráfica es bastante anterior</p>

<p>Empleado en un principio en campos de análisis y ciencia, poco a poco fue convirtiéndose en un vehículo para la creatividad hasta llegar, ahora sí, al primer largometraje de animación generado en base a la computación gráfica por ordenador (animación 3D) de 1995.</p>

<p>Sin embargo, las herramientas empleadas para este fin ya habían tenido cabida en el cine un par de años antes, de manera destacable, en la recreación de modelos digitales para dar vida en determinados momentos a los dinosaurios que poblaban Jurassic Park. Las posibilidades del hardware y del software en ese momento eran limitadas y, en los años venideros, su crecimiento, desarrollo y perfeccionamiento ha sido exponencial.</p>

<p>Si comparamos la obra de Pixar, podemos apreciar la evolución claramente en la calidad de la representación de las luces, las texturas, los elementos que se muestran en pantalla o la densidad de la malla. En general, queda claro que la tecnología se consolida y, tras más de 20 años haciendo largometrajes, podemos decir que la industria del modelado 3D y de la animación se encuentra más que asentada y en un momento deslumbrante.
...
¿Qué ha cambiado, cómo ha cambiado y por qué? En resumen: ha cambiado todo. El cambio básico, no obstante, es el acceso de cualquier persona mediante un simple clic a una máquina que es más potente que cualquiera en las que basaban la realidad virtual en los años 80. ¡Y las llevamos en el bolsillo!</p>

<p>a era de la información ha permitido que, en seis años, hayamos pasado de un precario acercamiento a la realidad virtual de la nueva era (Oculus Rift DK1) a avanzados dispositivos con pantallas que triplican la tasa de refresco que ofrecía aquel modelo (frames por segundo), a sistemas de “tracking” que nos permiten escondernos bajo una mesa digital o caminar por toda la habitación en el mundo real y recorrer todo un mundo virtual. La respuesta, la calidad de las lentes y la calidad de los dispositivos ha mejorado increíblemente rápido en una carrera de conquista industrial por ser el dispositivo líder en ventas.</p>
...
No es necesario desarrollar un talento artístico y técnico elevado en estas herramientas para poder tener un acercamiento a la realidad virtual: podemos emplear contenido generado por terceros y de venta o descarga gratuita online. Es tan simple como decidir qué contenido queremos generar o qué experiencia nos gustaría vivir en realidad virtual y hacer una búsqueda correcta de los elementos que queremos que pueblen ese mundo tridimensional.</p>

<p>De esta manera, no alcanzaremos una experiencia pulida y bien desarrollada de realidad virtual, pero sí podremos tener una maqueta de nuestra idea. Obtendremos un mockup de lo que nos gustaría desarrollar y podremos adentrarnos en el contenido para explorarlo y saber qué cosas funcionan y cuales no.

El modelado 3D en realidad virtual es una varita mágica que abre la puerta a los confines de tu imaginación: aprender a utilizarla te permitirá construir sueños imposibles.</p>
</div>
     ...
     <footer>
      ...
      <section class="ft-legal">
        <ul class="ft-legal-list">
          ...
          <li><a href="#">Politica de privacidady</a></li>

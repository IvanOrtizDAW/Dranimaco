...
<head>
  ...
  <title>Pagina de tutoriales de nivel medio de Dranimaco</title>
</head>
...
<body>
  ...
  <header>
    <nav class="menu-navegacion">
      <ul>
        ...
        <li class="menu"><a href="../../Ingles/DENTRO/medio.php"><img class="imagen-idioma"
  ...
  <section>
    ...
    <h5>Proceso de Creación de un Personaje con Blender Sculpt Capítulo Extra</h5>
    <div class="tutoriales-medio">
      <iframe class="video" src="https://www.youtube.com/embed/LC2ZOof6pZw" 
        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <h5>🏁 TECNICAS de MODELADO 3D 🏁 | Curso Blender 2.8 Principiante | Magnaomega</h5>
    <div class="tutoriales-medio">
      <iframe class="video" src="https://www.youtube.com/embed/rSR7ZNLImyI" 
        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <h5>Torre medieval en Blender 2.8 español 2/2 | Modelado en Blender |</h5>
    <div class="tutoriales-medio">
      <iframe  class="video" src="https://www.youtube.com/embed/nT5yx8l3uYM" 
        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>

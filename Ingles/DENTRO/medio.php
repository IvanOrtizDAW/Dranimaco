...
<head>
  ...
  <title>Dranimaco Medium Tutorials Page</title>
</head>
...
<body>
      ...
      <ul>
        ...
        <li class="menu">
          ...
          <ul>
            ...
            <li class="menu2">
              <a href="#"><i class="fas fa-play-circle"></i> Middle</a>
            </li>
            <li class="menu2">
        ...
        <li class="menu"><a href="../../Español/DENTRO/medio.php"><img class="imagen-idioma"
  ...
  <section>
    ...
    <h5>Blender 2.8 Creature Sculpting (New Sculpt Mode Demo)</h5>
    <div class="tutoriales-medio">
      <iframe class="video" src="https://www.youtube.com/embed/5MW0hfJnG2M"
        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <h5>Making Tracer's Gun from Overwatch in Blender</h5>
    <div class="tutoriales-medio">
      <iframe class="video" src="https://www.youtube.com/embed/1zFdii2aWSQ"
        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <h5>Galata Tower Blender 2.8 Modeling</h5>
    <div class="tutoriales-medio">
      <iframe class="video" src="https://www.youtube.com/embed/d31YmDIxC8I" 
        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>

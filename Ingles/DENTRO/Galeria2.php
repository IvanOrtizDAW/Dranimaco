...
<head>
  ...
  <title>Page 2 of the gallery of images of animation and 3D modeling</title>
</head>
...
<body>
  ...
  <header>
    <nav class="menu-navegacion">
      <ul>
        ...
        <li class="menu">
          <a href="../../Español/DENTRO/Galeria2.php"><img class="imagen-idioma" src="../../Imagenes/Español.png" alt=""/></a>
        </li>
  ...
  <ul class="pagination">
    <li class="page-item">
      <a class="page-link" href="Galeria.php">Previous</a>
    </li>
    ...
    <li class="page-item">
      <a class="page-link" href="Galeria3.php">Next</a>
    </li>
  </ul>
